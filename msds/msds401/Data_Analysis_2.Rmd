...
p1 = ggplot(dat, aes(x=VOLUME)) + 
  geom_histogram() + 
  facet_grid(~TYPE) +
  labs(title=sprintf("Histogram of Volume for both Adult and Infant abalones"), xlab="Volume (cc)")
p2 = ggplot(dat, aes(sample=VOLUME)) + 
  geom_qq() + 
  geom_qq_line() + 
  facet_grid(~TYPE) +
  labs(title=sprintf("QQ Plot of Volume for both Adult and Infant abalones"), xlab="Volume (cc)")

p3 = ggplot(dat, aes(x=VOLUME, y=TYPE)) + 
  geom_boxplot() + 
  labs(title=sprintf("Boxplots of Volume for both Adult and Infant abalones"), xlab="Volume (cc)")
...
ggplot(dat, aes(x=L_SHUCK, y=L_VOLUME, color=CLASS)) +
  labs(title=sprintf("Histogram of Volume for both Adult and Infant abalones"), xlab="log SHUCK (g)", ylab="log VOLUME (cc)") +
  geom_point()
```
